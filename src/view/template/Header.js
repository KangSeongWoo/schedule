...
const Headers = (props) => {
    ...
    if(props.mode === "header") {
        ...
        return (
            <div className="headers flex-center-center">
                <div>
        ...
        return (
            <div className="headers flex-center-center" style={{height : '15px'}}>
                {
                    props.goback && (
